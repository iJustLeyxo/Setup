package com.cavetale.setup.parser;

import com.cavetale.setup.Setup;
import com.cavetale.setup.parser.container.Container;
import com.cavetale.setup.util.console.Console;
import com.cavetale.setup.util.console.Detail;
...
public final class Parser {
    ...
    public boolean analyse() {
        ...
        if (Flag.INTERACTIVE.isSelected() && !Setup.interactive) {
